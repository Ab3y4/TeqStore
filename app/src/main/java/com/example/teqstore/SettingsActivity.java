...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private EditText fullNameEditText, userPhoneEditText, addressEditText,usernameEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInfoDisplay(profileImageView, fullNameEditText, userPhoneEditText, addressEditText, usernameEditText);
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText addressEditText, final EditText usernameEditText)
    {
